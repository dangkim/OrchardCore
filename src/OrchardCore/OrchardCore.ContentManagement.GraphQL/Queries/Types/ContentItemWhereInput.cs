...
namespace OrchardCore.ContentManagement.GraphQL.Queries.Types
{
    ...
    public class ContentItemWhereInput : WhereInputObjectGraphType
    {
        public ContentItemWhereInput(string contentItemName)
        {
            ...
            AddScalarFilterFields<StringGraphType>("valueForSortingOne", "the value for sorting of the content item");
            AddScalarFilterFields<StringGraphType>("valueForSortingTwo", "the value for sorting of the content item");
            AddScalarFilterFields<StringGraphType>("valueForSortingThree", "the value for sorting of the content item");
